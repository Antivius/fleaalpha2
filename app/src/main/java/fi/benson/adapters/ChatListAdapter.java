...
public class ChatListAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final boolean isMe = message.getSenderId().equals(currentUser.getObjectId());
        ...
        if (isMe) {
            ...
            Picasso.with(getContext()).load("https://scontent-arn2-1.xx.fbcdn.net/v/l/t1.0-9/10450936_10153530497392044_420639374741255249_n.jpg?oh=1135da01b5f254290e4ce35f76230bca&oe=57B9DA3B").into(profileView);
        } else {
